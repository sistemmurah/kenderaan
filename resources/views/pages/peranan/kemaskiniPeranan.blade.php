                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Peranan</label>
                                <input id="peranan" type="text" class="form-control" value="PSM" disabled="disabled"/>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <table class="datatable datatable-head-custom table-hover table-light table-bordered" id="kt_datatable_maca">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <label class="checkbox">
                            <input type="checkbox" name="beriKelulusan" />
                            <span></span>
                        </label>
                    </td>
                </tr>
