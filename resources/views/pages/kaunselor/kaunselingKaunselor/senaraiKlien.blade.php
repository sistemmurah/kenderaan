...
<div class="card card-custom gutter-b">
    ...
    <div class="card-body">
        ...
        <!-- Mula: Datatable-->
        <table class="datatable datatable-head-custom table-hover table-light table-bordered" id="kt_datatable_klien">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="text-right p-0">
                        <button
                            onclick="window.location ='{{ route('kaunselingKaunselor.kemaskiniKlien') }}'"
...
<!-- Mula: script datatable senarai klien -->
<script>
    var KTDatatableHtmlTableKlien = function () {
        var klien = function () {
            var datatableKlien = $('#kt_datatable_klien').KTDatatable({
                data: {
                    saveState: {
                        cookie: false
                    },
    ...
    jQuery(document).ready(function () {
        KTDatatableHtmlTableKlien.init();
    });
</script>
<!-- Tamat: script datatable senarai klien -->
