...
@section('content')
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-hover table-light table-bordered" id="kt_datatable">
                ...
                <tr>
                    ...
                    <th style="text-align: center">Tarikh Tutup</th>
                ...
                <tr>
                    ...
                    <td style="text-align: center">20/2/2021</td>
    ...
    <div class="card card-custom" data-card="true" id="kt_card_1">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label"><i class="fas fa-home"></i> Pengesahan Penerimaan</h3>
            </div>
            <div class="card-toolbar">
                <a href="#" class="btn btn-icon btn-sm btn-hover-light-primary mr-1" data-card-tool="toggle"
                   data-toggle="tooltip" data-placement="top" title="Toggle Card">
        ...
        <div class="card-body">
            ...
            <div>
                <div class="row">
                    ...
                    <div class="col-lg-9" >
                        <div class="form-group">
                            <label> Sukacita dimaklumkan bahawa permohonan saudara untuk menduduki peperiksaan
                                    perkhidmatan telah <b>DILULUSKAN.</b> Sila buat pengesahan penerimaan
                                    <b>SETUJU</b>  dan jika <b>TIDAK SETUJU</b>  sila nyatakan alasan.</label>
                            </br>
                            <font color="red"> Alasan ( Wajib diisi jika TIDAK SETUJU)</font>
                            </br>
            ...
            <div id="MyContentPlaceHolder_savebtn">
                <div class="col-lg-19">
                    <div style="text-align: center;">
                        <button class="btn btn-primary font-weight-bold" style="align-items: center"> Setuju
                        </button>
                        <button class="btn btn-danger font-weight-bold" style="align-items: center"> Tidak Setuju
                        </button>
