...
<div class="card card-custom gutter-b">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <button onclick="window.location = '{{ route('pertukaranStaf.tambahPertukaran') }}'"
                class="btn btn-success font-weight-bold" data-toggle="tooltip" title="Tambah Permohonan Pertukaran">
    ...
    <div class="card-body">
        ...
        <!-- Mula: Datatable-->
        <table class="datatable datatable-head-custom table-hover table-light table-bordered" id="kt_datatable_pertukaran">
            ...
            <tr>
                    ...
                    <td class="text-right p-0">
                        <button
                            onclick="window.location ='{{ route('pertukaranStaf.tambahPertukaran') }}'"
