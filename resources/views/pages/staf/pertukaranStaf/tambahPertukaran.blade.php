                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="tkhMasuk" disabled="disabled" type="date" class="form-control"
                                placeholder="{{ now()->toDateString('Y-m-d') }}" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>Tarikh Sah Jawatan<span class="text-danger">*</span></label>
                            <input id="tkhSahJwtn" disabled="disabled" type="date" class="form-control"
                                placeholder="{{ now()->toDateString('Y-m-d') }}" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="tkhLantikanTerkini" disabled="disabled" type="date" class="form-control"
                                placeholder="{{ now()->toDateString('Y-m-d') }}" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="tarafJwtn" disabled="disabled" type="text" class="form-control" placeholder="Taraf Jawatan" />
                        </div>
                    </div>
                </div>
                <!-- Mula: Accordion -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="alasanPertukaran">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input id="ptjBaru" type="text" class="form-control" placeholder="Sila Nyatakan" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="justifikasi" rows="2"
                                placeholder="Nyatakan Justifikasi Disini"></textarea>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <td class="text-right p-0">
                                            <button type="button" class="btn btn-sm btn-icon btn-primary"
                                                id="uploadFilePertukaran">
                                                <i class="fas fa-upload" data-toggle="tooltip" data-placement="top"
                                                    title="Tooltip">
                                                </i>
                                            </button>
                                        </td>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <div class="checkbox-list">
                                <h6 class="checkbox">
                                    <input type="checkbox" name="pengakuan" />
                                    <span></span>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="pegawaiPSM">
                                ...
                                <option>11330 - NAZLIN BINTI ALI</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-6">
    ...
    <div class="col-lg-12">
        <div class="card card-custom gutter-b card ">
            <div class="card-body text-center">
                <button onclick="window.location = '{{ route('pertukaranStaf.senaraiPertukaran') }}'"
