                                        ...
                                        <div class="col-md-4 my-2 my-md-0">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <select class="form-control"
                                                    id="kt_datatable_keluarga_search_status">
...
<div class="card card-custom gutter-b">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <button onclick="window.location = '{{ route('pergigianStaf.tambahPergigian') }}'"
                class="btn btn-success font-weight-bold" data-toggle="tooltip" title="Tambah Permohonan Tuntutan">
    ...
    <div class="card-body">
        ...
        <!-- Mula: Datatable-->
        <table class="datatable datatable-head-custom table-hover table-light table-bordered" id="kt_datatable_tuntutanStaf">
            <thead style="background-color:#fcf4a3">
            <tr>
                    <th title="Field #1">Bil</th>
