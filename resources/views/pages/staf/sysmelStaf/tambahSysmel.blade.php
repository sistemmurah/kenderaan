        ...
        <div class="card card-custom gutter-b card card-custom">
            ...
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <button onclick="window.location = '{{ route('sysmelStaf.tambahPenerima') }}'"
                        class="btn btn-success font-weight-bold" data-toggle="tooltip" title="Tambah Penerima">
                        <i class="fas fa-plus-circle"></i></i> Tambah
                    </button>
                </div>
            </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-right p-0">
                                <button
                                    onclick="window.location ='{{ route('sysmelStaf.tambahPenerima') }}'"
                        ...
                        <tr>
                            <td>4</td>
                            <td>MY7013900133</td>
                            <td>MOHD ISHAK BIN ABU BAKAR</td>
                            <td>POS LAJU</td>
                            <td>17/01/2021</td>
                            <td>Dipos</td>
                            <td class="text-right p-0">
    ...
    <div class="col-lg-12">
        <div class="card card-custom gutter-b card ">
            <div class="card-body text-center">
                <button onclick="window.location = '{{ route('sysmelStaf.senaraiSysmel') }}'"
