                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox-list">
                                <label class="checkbox">
                                    <input type="checkbox" name="isytiharKaliPertama" />
                                    <span></span>
                                    Tiada harta yang diisytiharkan (Bagi Pengisytiharan Harta Kali Pertama)
                                </label>
                                <label class="checkbox">
                                    <input type="checkbox" name="isytiharSemula" />
                                    <span></span>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>Status<span class="text-danger">*</span></label>
                            <select class="form-control" id="pengesahanDekan" disabled="disabled">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>Status<span class="text-danger">*</span></label>
                            <select class="form-control" id="pengesahanUrusetia" disabled="disabled">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>Status<span class="text-danger">*</span></label>
                            <select class="form-control" id="pengesahanPegawaiUrusetia" disabled="disabled">
