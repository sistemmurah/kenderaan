                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="jenisPendapatanStaf">
                    ...
                    <div class="col-lg-6" id="lainStaf">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Jenis Pendapatan" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea id="maklumatPendapatanStaf" class="form-control" rows="3"
                                placeholder="Sila Nyatakan Maklumat Pendapatan"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row" id="bulananTahunan">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="stafBulananTahunan">
                                <option value="1">Sila Pilih</option>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="jumlahBulananStaf" type="text" class="form-control" placeholder="0.00" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <table class="datatable datatable-head-custom table-hover table-light table-bordered"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input id="namaFailLampiranStaf" type="text" class="form-control" />
                                </div>
                            </td>
                            <td class="text-right p-0">
                                <button type="button" class="btn btn-sm btn-icon btn-primary" id="uploadFileStaf">
