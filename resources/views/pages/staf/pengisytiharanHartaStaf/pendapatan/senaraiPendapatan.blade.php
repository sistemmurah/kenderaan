                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="maklumatPendapatan">
                                <option value="1">Sila Pilih</option>
                                <option value="2">PERSENDIRIAN BUJANG</option>
                                <option value="3">PERSENDIRIAN BERKAHWIN</option>
                                <option value="4">PERSENDIRIAN BERPISAH</option>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-toolbar text-right">
                                    <button
                                        onclick="window.location = '{{ route('pengisytiharanHartaStaf.pendapatan.tambahPendapatanStaf') }}'"
                                        class="btn btn-success font-weight-bold" data-toggle="tooltip"
                                        title="Tambah Pendapatan Bulanan">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-toolbar text-right">
                                    <button
                                        onclick="window.location = '{{ route('pengisytiharanHartaStaf.pendapatan.tambahPendapatanPasangan') }}'"
                                        class="btn btn-success font-weight-bold" data-toggle="tooltip"
                                        title="Tambah Pendapatan Bulanan">
                                        <i class="fas fa-plus-circle"></i>
                                        Tambah
