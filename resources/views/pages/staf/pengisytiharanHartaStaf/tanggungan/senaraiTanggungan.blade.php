                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card-toolbar text-right">
                                            <button
                                                onclick="window.location = '{{ route('pengisytiharanHartaStaf.tanggungan.tambahTanggunganStaf') }}'"
                                                class="btn btn-success font-weight-bold" data-toggle="tooltip"
                                                title="Tambah Pinjaman/Tanggungan Staf">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card-toolbar text-right">
                                            <button
                                                onclick="window.location = '{{ route('pengisytiharanHartaStaf.tanggungan.tambahTanggunganPasangan') }}'"
                                                class="btn btn-success font-weight-bold" data-toggle="tooltip"
                                                title="Tambah Pinjaman/Tanggungan Pasangan">
                                                <i class="fas fa-plus-circle"></i>
                                                Tambah
                                            </button>
                                        </div>
    ...
    <div class="col-lg-12">
        <div class="card card-custom gutter-b card ">
            <div class="card-body text-center">
                ...
                <button
                    onclick="window.location = '{{ route('pengisytiharanHartaStaf.pengesahan') }}'"
