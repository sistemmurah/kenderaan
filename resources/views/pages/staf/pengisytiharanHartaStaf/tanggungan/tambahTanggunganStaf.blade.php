                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="kategoriPinjamanStaf">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="jumlahPinjamanStaf" type="text" class="form-control" placeholder="0.00" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text">RM</span></div>
                                <input id="ansuranBulananStaf" type="text" class="form-control" placeholder="0.00" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="tarikhAnsuranPertamaStaf" class="form-control" type="date" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="caraBayaranStaf">
                                <option value="1">Sila Pilih</option>
