                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="namaTanggungan" type="text" class="form-control"
                                placeholder="Nama Anak/Tanggungan" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="umurTanggungan" type="text" class="form-control"
                                placeholder="Umur Anak/Tanggungan" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="hubunganAnak">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="statusSekolahTanggungan">
                                <option>Sila Pilih</option>
                                <option>YA</option>
                                <option>TIDAK</option>
                            </select>
