                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card-toolbar text-right">
                                            <button
                                                onclick="window.location = '{{ route('pengisytiharanHartaStaf.peribadi.tambahPasangan') }}'"
                                                class="btn btn-success font-weight-bold" data-toggle="tooltip"
                                                title="Tambah Maklumat Pasangan">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card-toolbar text-right">
                                            <button
                                                onclick="window.location = '{{ route('pengisytiharanHartaStaf.peribadi.tambahIbuBapa') }}'"
                                                class="btn btn-success font-weight-bold" data-toggle="tooltip"
                                                title="Tambah Maklumat IbuBapa/Penjaga">
                                                <i class="fas fa-plus-circle"></i>
                                                Tambah
                                            </button>
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card-toolbar text-right">
                                            <button
                                                onclick="window.location = '{{ route('pengisytiharanHartaStaf.peribadi.tambahAnak') }}'"
                                                class="btn btn-success font-weight-bold" data-toggle="tooltip"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card-toolbar text-right">
                                            <button
                                                onclick="window.location = '{{ route('pengisytiharanHartaStaf.peribadi.tambahWaris') }}'"
                                                class="btn btn-success font-weight-bold" data-toggle="tooltip"
                                                title="Tambah Maklumat Waris">
                                                <i class="fas fa-plus-circle"></i>
                                                Tambah
                                            </button>
                                        </div>
    ...
    <div class="col-lg-12">
        <div class="card card-custom gutter-b card ">
            <div class="card-body text-center">
                <button
                    onclick="window.location = '{{ route('pengisytiharanHartaStaf.senaraiPengisytiharan') }}'"
