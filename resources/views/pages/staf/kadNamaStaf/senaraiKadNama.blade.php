...
<div class="card card-custom gutter-b">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <button onclick="window.location = '{{ route('kadNamaStaf.tambahKadNama') }}'"
                class="btn btn-success font-weight-bold" data-toggle="tooltip" title="Tambah Permohonan Kad Nama">
