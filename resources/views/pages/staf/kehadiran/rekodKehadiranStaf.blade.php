        ...
        <table class="datatable datatable-head-custom table-hover table-light table-bordered" id="kt_datatable_permit">
            <thead style="background-color:#fcf4a3">
                <tr>
                    ...
                    <th title="Field #6">Apa</th>
                    <th title="Field #7">Kehilangan Masa</th>
                    <th title="Field #8">Sumbangan Masa</th>
                    <th title="Field #9">Kerja Lebih Masa</th>
                    <th title="Field #10">Isu/Catatan</th>
                    <th title="Field #11">Status</th>
                    <th title="Field #12">Aliran Kerja</th>
                </tr>
            </thead>
            <tbody>
                <tr>
