                ...
                <thead class="colored">
                    ...
                    <tbody>
                                <tr>                                  
                                       ...
                                       <a href=" {{ route('urusetia.TatatertibBPO.MaklumatKesTatatertibBPO') }}" onclick="fnCallModalItem(this);" id="activityAdDetails_@item.WARAN_PK" data-id="@item.WARAN_PK~~KEMASKINI" class="btn btn-outline-success btn-sm m-btn m-btn--icon m-btn--pill" title="Kemaskini"><i class="la la-edit"></i></a>
