...
<div class="d-flex flex-column-fluid">
    <div class="container">
        ...
        <div class="card card-custom" data-card="true" id="kt_card_1">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label"><i class="fa fa-search text-dark"></i>&nbsp;&nbsp; Penentuan Pelanggaran</h3>
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <textarea rows="4" cols="100" name="comment" form="usrform">Menerima laporan daripada Ketua Pegawai Tatatertib pada 2 Januari 2021
                            Pegawai didapati tidak hadir bertugas tanpa sebarang notis cuti atau kebenaran terlebih dahulu dan tiafa sebab munasabah selama 44 hari</textarea>
                        </div>                                                                                       
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                        <input type="radio" id="keputusan1" name="keputusan1" value="keputusan1">
                        <label for="female">Hukuman lebih ringan daripada buang kerja atau turun pangkat</label><br>
                        </div>     
                        <div class="col-lg-12">
                        <input type="radio" id="keputusan2" name="keputusan2" value="keputusan2">
                        <label for="female">Hukuman buang kerja atau turun pangkat</label><br>
                        </div>                                                                                   
                    </div>
                                ...
                                <thead class="colored">
                                    ...
                                    <tbody>
                                            <tr>                                  
                                                    ...
                                                    <td style="text-align:center;">Keputusan.pdf</td>
                                                    <td style="text-align:center;">
                                                    <a onclick="fnCallModalItem(this);" id="activityAdDetails_@item.WARAN_PK" data-id="@item.WARAN_PK~~KEMASKINI" class="btn btn-outline-success btn-sm m-btn m-btn--icon m-btn--pill" title="Kemaskini"><i class="la la-edit"></i></a>
                                                        <button type="button" id="IdButangDelete" onclick="deleteWaran(this)" data-id="@item.WARAN_PK~~HAPUS" class="btn btn-outline-warning btn-sm m-btn m-btn--icon m-btn--pill"><i class="flaticon-delete" title="Hapus"></i></button>                                       
                                                    </td> 
