		...
		<div class="col-md-12">
			<div class="card">				
				...
				<div class="card-body">
					...
					<input name="car_id" type="hidden" value="1">
					<input name="driver_id" type="hidden" value="1">
					<input name="staff_id" type="hidden" value="1">
							...
							<div class="form-group">
									<label >Type</label>
									<select class="form-control  kt-select2 select2" id="kt_select2_1" name="type_id">
                        ...
                        <input type="text" class="form-control" placeholder="Sila masukkan tarikh" id="kt_datepicker_5" value="{{ $edit ? $booking->time_returned : old('date_returned') }}" />
...
<script src="{{ asset('js/pages/Scripts/Lantikan/keluarga_calendar.js') }}"></script>
