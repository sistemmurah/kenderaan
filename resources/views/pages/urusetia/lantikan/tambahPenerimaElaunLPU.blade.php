...
<div class="d-flex flex-column-fluid">
    <div class="container">
        <!-- Maklumat Tuntutan Bayaran Elaun Ahli Lembaga-->     
            <div class="card card-custom" data-card="true" id="kt_card_1">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label"><i class="fa flaticon-users text-dark"></i>&nbsp;&nbsp;Tuntutan Bayaran Elaun Ahli Lembaga</h3>
                    </div>
        ...
        <br/>
         ...
         <!-- Maklumat Maklumat Tuntutan-->     
         <div class="card card-custom" data-card="true" id="kt_card_1">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label"><i class="fa flaticon-users text-dark"></i>&nbsp;&nbsp; Maklumat Tuntutan</h3>
                    </div>
                            ...
                            <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable">
                                <thead class="colored">
                                        ...
                                        <th width="3%" style="text-align:center;">Bil</th>
                                            ...
                                            <th width="10%" style="text-align:center;">Tarikh Mula</th>
                                            <th width="10%" style="text-align:center;">Tarikh Tamat</th>
                                            <th width="10%" style="text-align:center;">Jumlah Jam</th>
                                            <th width="10%" style="text-align:center;">Keterangan Tugas</th>
                                    ...
                                    <tbody>
                                            <tr>                                  
                                                    ...
                                                    <td style="text-align:center;">27/12/2020</td>
                                                    <td style="text-align:center;">10 Jam</td>
                                                    <td style="text-align:center;">Menjalanakan tugas</td>
                                                    <td style="text-align:center;">Menjalanakan tugas</td>
        ...
        <br/>
        <!-- Bukti Lampiran Tuntutan-->     
        <div class="card card-custom" data-card="true" id="kt_card_1">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label"><i class="fa flaticon-users text-dark"></i>&nbsp;&nbsp;Lampiran Tuntutan</h3>
                    </div>
                            ...
                            <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable">
                                <thead class="colored">
                                    ...
                                    <tbody>
                                            <tr>                                  
                                                    <td style="text-align:center;">1.</td>
                                                    <td style="text-align:center;">Tuntutan</td>
                                                    <td style="text-align:center;">Tuntutan.pdf</td>
                                                    <td style="text-align:center;>
                                            ...
                                            <tr>                                  
                                                    ...
                                                    <td style="text-align:center;">Minit Mesyuarat</td>
                                                    <td style="text-align:center;">minit.pdf</td>
                                                    <td style="text-align:center;>
                                                        <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Files\Download.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <rect x="0" y="0" width="24" height="24"/>
            ...
            <div id="MyContentPlaceHolder_savebtn">
                    <div class="col-lg-12">
                        <div style="text-align: center;padding-top: 10px;padding-bottom: 10px;">   
                            <button type="submit" id="IdButangCetak" class="btn btn-light-warning"><i class="fa fa-print"></i> Cetak</button>                 
