...
<div class="d-flex flex-column-fluid">
        <div class="container">
            ...
            <div class="card card-custom" data-card="true" id="kt_card_1">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label"><i class="fa fa-list text-dark"></i>&nbsp;&nbsp;Senarai Calon Layak Temuduga</h3>
                    </div>
                ...
                <div class="card-body">
                    <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable">
                        ...
                        <tbody>
                           <tr>
                                        <td>1.</td>
                                        <td><a href="">MOHD FAUZI BIN ISMAIL</a></td>
                                        <td>PEGAWAI TEKNOLOGI MAKLUMAT (FA41)</td>
                                        <td>12/01/2020</td>
                                        <td>8:00 Pagi</td>
                                        <td>PUSAT TRANSFORMASI BAKAT (TTC) UTM</td>
                                        ...
                                        <td>Surat Temuduga Selesai Disediakan</td> 
                                    </tr>
                           <tr>
                               <td>2.</td>
                               <td><a href="">MOHD SAZLI BINTI RAHMAN</a></td>
                               <td>PEGAWAI TEKNOLOGI MAKLUMAT (FA41)</td>
                               <td>12/01/2020</td>
                               <td>8:00 Pagi</td>
                               <td>PUSAT TRANSFORMASI BAKAT (TTC) UTM</td>
...
{{-- Scripts Section --}}
@section('scripts')
    <script src="{{ asset('js/pages/Scripts/Lantikan/CalonLayakTemuduga_table.js') }}"></script>
