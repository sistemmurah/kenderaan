...
@section('content')
    ...
    <!-- Mula: Maklumat Takwim Lantikan LPU -->
    ...
    <!-- Tamat: Maklumat Takwim  Lantikan LPU-->
        ...
        <div class="card-body">
            ...
            <div>
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="form-group">
                            <label><b>Nama/No. Kad Pengenalan/ No. Pekerja</b></label>
    ...
    <br/>
    <!-- Mula: Maklumat Ahli Lembaga Pengarah LPU-->
    <div class="card card-custom" data-card="true" id="kt_card_1">
        <div class="card-header">
            <div class="card-title">
                <div class="symbol symbol-40  mr-5">
                ...
                <h3 class="card-label">Maklumat Ahli Lembaga Pengarah LPU</h3>
            </div>
            <div class="card-toolbar">
            ...
            <div>
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <div class="col-lg-12"><label><b>Tarikh</b></label></div>
                                <div class="col-lg-12">
                        ...
                        <div class="col-lg-4"><label><b>Tempat</b></label></div>
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label><b>Kehadiran Pengerusi</b></label>
                                <select class="form-control" id="CarianPesara">
                                    <option>Sila Pilih</option>
                                    <option>Hadir</option>
    ...
    <!-- Mula: MuatNaik Kertas Kerja Pencalonan-->
    <div class="card card-custom" data-card="true" id="kt_card_1">
        ...
        <div class="card-header">
            <div class="card-title">
                <div class="symbol symbol-40  mr-5">
                <span class="">
                    {{ Metronic::getSVG("media/svg/icons/Files/Upload-folder.svg", "svg-icon-lg") }}
                </span>
                </div>
                <h3 class="card-label">Muatnaik Kertas Kerja Pencalonan</h3>
            </div>
            <div class="card-toolbar">
                <a href="" class="btn btn-icon btn-sm btn-hover-light-primary mr-1" data-card-tool="toggle"
                   data-toggle="tooltip" data-placement="top" title="Toggle Card">
        ...
        <div class="card-body">
            ...
            <div>
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="form-group">
                            <label><b>Muatnaik lampiran fail</b></label>
                            <div></div>
        ...
        $(document).ready(function() {
            ...
            */
            ...
            var calendar =  $('#calendar').fullCalendar({
                ...
                events: [
                    {
                        title: 'Mesyuarat LPU 1',
                        start: new Date(y, m, 1)
                    },
                    {
                        id: 999,
                        title: 'Mesyuarat LPU 2',
                    ...
                    {
                        id: 999,
                        title: 'Mesyuarat LPU 5',
                        start: new Date(y, m, d+4, 16, 0),
                        allDay: false,
                        className: 'info'
                    },
                    {
                        title: 'Mesyuarat LPU 3',
                        start: new Date(y, m, d, 10, 30),
                        allDay: false,
                        className: 'important'
                    },
                    {
                        title: 'Mesyuarat LPU 4',
