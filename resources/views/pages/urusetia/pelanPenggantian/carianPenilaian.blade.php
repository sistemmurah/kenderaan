                ...
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">
                            ...
                            Penilaian dan Pemarkahan Kumpulan Bakat
                        </h3>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-10">
                                            ...
                                            <div class="card-toolbar" style="text-align: center">
                                                <button onclick="window.location = '{{ route('urusetia.pelanPenggantian.carianPenilaian') }}'"
                                                        class="btn btn-primary font-weight-bold" data-toggle="tooltip"
                                                        title="Carian Calon">
                                                    <i class="fas fa-search-plus"></i>
                                                    Cari
                                                </button>
                                                <button onclick="window.location = '{{ url('/pelanPenggantian/carianPenilaian')}}'"
                                            ...
                                            <div class="my-5">
                                                ...
                                                <table class="datatable datatable-head-custom table-hover table-light table-bordered"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th title="Field #6">Kod Organisasi</th>
                                                    ...
                                                    @if($edit)
                                                        <tr>
                                                            <td>1</td>
                                                            <td>
                                                                <a href='{{ route('urusetia.pelanPenggantian.calonMarkInfo') }}'>PB/2013/N48/001</a>
                                                            </td>
                                                            <td>5432</td>
                                                            <td>HASMAH BINTI ALI</td>
                                                            <td>PENTADBIR BUKAN AKADEMIK</td>
