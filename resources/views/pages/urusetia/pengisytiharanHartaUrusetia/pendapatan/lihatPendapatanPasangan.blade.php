                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="jenisPendapatanPasangan" disabled="disabled">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group" id="lainPasangan">
                            ...
                            <input type="text" class="form-control" value="Sila Nyatakan" disabled="disabled"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row" id="bulananTahunan">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="pasanganBulananTahunan" disabled="disabled">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="jumlahBulananPasangan" type="text" class="form-control" value="2000.00" disabled="disabled" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
