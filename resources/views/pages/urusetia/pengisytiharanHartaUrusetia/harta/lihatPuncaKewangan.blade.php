                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="kategoriPunca" disabled="disabled">
                    ...
                    <div class="col-lg-6" id="lainPunca">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="Punca Kewangan" disabled="disabled" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input id="maklumatPuncaKewangan" type="text" class="form-control"
                                value="Pinjaman Dari Bank" disabled="disabled"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="statusPembayaran" disabled="disabled">
                    ...
                    <div class="col-lg-6" id="bayaranOleh">
                        <div class="form-group">
                            <label>Sila Nyatakan<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" value="Bayaran Oleh" disabled="disabled"/>
                        </div>
                    </div>
                </div>
            </div>
