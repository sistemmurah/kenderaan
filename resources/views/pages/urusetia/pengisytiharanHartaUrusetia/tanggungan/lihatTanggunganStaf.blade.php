            ...
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">
                        ...
                        Maklumat Pinjaman/Tanggungan Staf
                    </h3>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="kategoriPinjamanStaf" disabled="disabled">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group" id="lainKategoriStaf">
                            <label>Sila Nyatakan<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" value="Kategori Pinjaman/Tanggungan" disabled="disabled"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="maklumatPinjamanStaf" type="text" class="form-control"
                                value="Pinjaman Kenderaan" disabled="disabled"/>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>Institusi Memberi Pinjaman/Tanggungan<span class="text-danger">*</span></label>
                            <input id="institusiPinjaman" type="text" class="form-control"
                                value="MAYBANK" disabled="disabled"/>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="jumlahPinjamanStaf" type="text" class="form-control" value="10000.00" disabled="disabled" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text">RM</span></div>
                                <input id="ansuranBulananStaf" type="text" class="form-control" value="300.00" disabled="disabled"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group">
                                                <input type="number" class="form-control" value="10"
                                                    id="tempohTahunStaf" disabled="disabled"/>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group">
                                                <input type="number" class="form-control" value="0"
                                                    id="tempohBulanStaf" disabled="disabled"/>
                                                <div class="input-group-append" >
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="tarikhAnsuranPertamaStaf" class="form-control" type="date" value="2021-01-01" disabled="disabled"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="caraBayaranStaf" disabled="disabled">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group" id="lainKeteranganStaf">
                            <label>Keterangan Lain</label>
                            <input type="text" class="form-control" value="Keterangan Lain" disabled="disabled" />
                        </div>
                    </div>
                </div>
...
<script>
    $('#lainKategoriStaf').hide();

    $('#kategoriPinjamanStaf').change(function () {
        if ($(this).val() == 8) {
            $('#lainKategoriStaf').show();
        } else {
            $('#lainKategoriStaf').hide();
        }
    });
