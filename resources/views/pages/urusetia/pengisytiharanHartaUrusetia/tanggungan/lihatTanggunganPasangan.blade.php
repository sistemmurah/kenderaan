                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="kategoriPinjamanPasangan" disabled="disabled">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="jumlahPinjamanPasangan" type="text" class="form-control"
                                    value="10000.00" disabled="disabled"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="ansuranBulananPasangan" type="text" class="form-control"
                                    value="300.00" disabled="disabled"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group">
                                                <input type="number" class="form-control" value="10"
                                                    id="tempohTahunPasangan" disabled="disabled"/>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group">
                                                <input type="number" class="form-control" value="0"
                                                    id="tempohBulanPasangan" disabled="disabled"/>
                                                <div class="input-group-append">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="tarikhAnsuranPertamaPasangan" class="form-control" type="date" value="2021-01-20"disabled="disabled"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="caraBayaranPasangan" disabled="disabled">
