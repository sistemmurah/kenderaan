...
<!-- Mula: Senarai Staf Yang Menduduki Peperiksaan -->
    ...
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">
                ...
                Senarai Staf Yang Menduduki Peperiksaan
            </h3>
        </div>
    </div>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="text-right p-0">
                        <button onclick="window.location ='{{ route('kerani.peperiksaan.masukMarkahPeriksa') }}'"
                            type="button" class="btn btn-xs btn-light-primary font-weight-bold">Key In Keputusan
...
<!-- Tamat: Senarai Staf Yang Menduduki Peperiksaan -->
...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">
                <i class="fas fa-id-card"></i>
                Senarai Keputusan Peperiksaan Staf
            </h3>
        </div>
    </div>
    ...
    <div class="card-body">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-4 my-2 my-md-0">
                            <div class="d-flex align-items-center">
                                <div class="input-icon">
                        <input type="text" class="form-control" placeholder="Cari"
                            id="kt_datatable_result_search_query" />
                        <span><i class="flaticon2-search-1 text-muted"></i></span>
                    </div>
                            </div>
                        </div>
        ...
        <!-- Mula: Datatable-->
        <table class="datatable datatable-head-custom table-hover table-light table-bordered" id="kt_datatable_result">
            <thead style="background-color:#fcf4a3">
                <tr>
                    <th title="Field #1">Bil</th>
                    <th title="Field #3">Nama</th>
...
<!-- Mula: Script Datatable -->
<script>
    var KTDatatableHtmlTableResult = function () {
        var demo = function () {
            var datatable = $('#kt_datatable_result').KTDatatable({
                data: {
                    saveState: {
                        cookie: false
                    },
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        template: function (row) {
                            ...
                            return '<span class="label label-lg font-weight-bold label-inline ' +
                                keputusan[row.Keputusan].class + '">' + keputusan[row.Keputusan].title +
                                '</span>';
                        }
                    },
                ],
                ...
                search: {
                    input: $('#kt_datatable_result_search_query'),
                    key: 'generalSearch'
                },
            });

            $('#kt_datatable_result_search_status').on('change', function () {
                // regExSearch = '^\\s' + $(this).val().toLowerCase() +'\\s*$';
                // alert(regExSearch);
                //alert($(this).val().toLowerCase());
                datatable.search($(this).val().toLowerCase(), 'Status');
            ...
            $('#kt_datatable_result_search_status').selectpicker();
        };
    ...
    jQuery(document).ready(function () {
        KTDatatableHtmlTableResult.init();
    });
</script>
<!-- Tamat: Script Datatable -->
